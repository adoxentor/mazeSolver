...
=======
<<<<<<< HEAD
>>>>>>> e4f38db367ffe1be89ef7886c67a193a94d4d243
...
=======
	...
	// Enable all sensors:
	Serial.println(imu.setSensors(INV_XYZ_GYRO | INV_XYZ_ACCEL | INV_XYZ_COMPASS));
...
void loop() {
	...
	myservo.write(45);
	Serial.println("Put the robot in the start of the maze, looking forword into the maze (parallel to the side wall). After you did it send 'G'");
	while (1) {
...
double angle() {
	...
	//   Serial.println(String(magX100));
	//   Serial.println(String(magY100));
	angleNow = atan2(magX100, magY100) * 180 / PI;
	//Serial.println(String(angleNow));
	return angleNow;
}
